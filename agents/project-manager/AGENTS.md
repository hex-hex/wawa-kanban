...
- Assign backlog tickets to developers/designers when they have capacity; assign verification to **code-verifier** or **general-verifier** by ticket mode (see TOOLS.md).
